...
⋅⋅* Χρησιμοποιώντας την δομή επανάληψης for 
⋅⋅* Χρησιμοποιώντας την δομή επανάληψης while 
⋅⋅* Καλώντας δύο συναρτήσεις evens και odds με παράμετρο το συνολικό πλήθος των αριθμών 
⋅⋅* Αποθηκεύντας τους αριθμούς σε πίνακα 
